...
namespace DnDCharacterCreator.Names
{
    public class Dragonborn : IName
    {
        ...
        public List<string> Male {
            get => new List<string>() {
            "Adrex", "Arjhan", "Azzakh", "Salasar", "Baradad",
            "Bharash", "Bidreked", "Dadalan", "Dazzazn", "Direcris",
            "Donaar", "Fax", "Gargax", "Ghesh", "Gorbundus",
            "Greethen", "Heskan", "Hirrathak", "lldrex", "Kaladan",
        ...
        public List<string> Clan {
            ...
            "Ophinshtalajiir", "Orexijandilin", "Pfaphnyrennish", "Phrahdrandon", "Pyraxtallinost",
            "Qyxpahrgh", "Raghthroknaar", "Shestendeliath", "Skaarzborroosh", "Sumnarghthrysh",
            "Tiammanthyllish", "Turnuroth", "Umbyrphrael", "Vangdondalor", "Verthisathurgiesh",
            "Wivvyrholdalphiax", "Wystongjiir", "Xephyrbahnor", "Yarjerit", "Zzzxaaxthroth",
        };
        }
    }
}
